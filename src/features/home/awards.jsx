function Award({ date, title, children }) {
  return (
    <div className="p-6 pb-8 bg-card h-78 bg-white flex flex-col justify-between">
...
export default function Awards() {
  return (
    <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-3">
      <Award date="Januar 2021" title="Top Finanzberater 2024">
        Als zertifizierte Finanzberater garantieren wir Qualität und Fachkenntnisse in unseren Dienstleistungen.
      </Award>
      <Award date="März 2020" title="Zertifizierte Unabhängigkeit">
       Unsere Auszeichnung als beste Finanzberater des Jahres bestätigt unsere Spitzenleistungen und Kundenzufriedenheit.
      </Award>
      <Award date="Juli 2019" title="Zertifizierte Unabhängigkeit">
        Unser Fokus auf exzellente Kundenbetreuung wurde mit dieser Auszeichnung honoriert und zeigt unser Engagement für unsere Kunden.
      </Award>
    </div>
  );
}
