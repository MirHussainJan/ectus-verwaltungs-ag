      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="p-5 md:p-[20px_16px] bg-white md:w-[263px] w-full">
          ...
          <div className="flex flex-col items-center mb-3">
            ...
            <h5 className="font-semibold text-[16px]/[150%]">Rainer Yaeger</h5>
          </div>
          <div className="flex flex-col gap-6">
            ...
            <div className="flex justify-between">
              ...
              <p className="font-medium text-[13px]/[100%]">24 Jan, 1992</p>
            </div>
            <div className="flex justify-between">
              <p className="font-semibold text-[13px]/[100%] text-[#7E7E7E]">
                Gender
              </p>
              <p className="font-medium text-[13px]/[100%]">Male</p>
            </div>
            <div className="flex justify-between">
              <p className="font-semibold text-[13px]/[100%] text-[#7E7E7E]">
                Country
              </p>
              <p className="font-medium text-[13px]/[100%]">Germany</p>
            </div>
          </div>
        </div>
        {/* right */}
        <div className="p-5 bg-white md:w-[312px] w-full flex flex-col gap-6">
          ...
          <div className="flex gap-6 justify-between">
            <div>
              ...
              <h4 className="font-semibold text-[20px]/[150%]">24</h4>
            </div>
            <div>
              <p className="font-medium text-[12px]/[100%] mb-1.5">
                Current Klarna Price
              </p>
              <h4 className="font-semibold text-[20px]/[150%]">€ 153</h4>
            </div>
          </div>
          <hr className="border-1 border-[#E2E8F0]" />
          <p className='mb-1.5 font-medium text-[12px]/[100%]'>Total Value</p>
          <h4 className="font-semibold text-[20px]/[150%]">€ 3000</h4>
        </div>
      </div>
    </div>
  );
